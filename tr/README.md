...
- English canonical kaynak: [`../README.md`](../README.md)
- Turkce localization mirror: [`README.md`](README.md)

Not: Repo koku English canonical kaynaktir. `tr/` altindaki icerik bakimi yapilan Turkce localization mirror'dir; `scripts/` tek kopya ve locale-aware olarak kalir.
