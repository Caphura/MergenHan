...
Bu dosya, kokteki [`../../docs/mergenhan-symbolism.md`](../../docs/mergenhan-symbolism.md) dosyasinin Turkish localization mirror'i olarak eklenmistir.
Canonical source root `docs/mergenhan-symbolism.md` dosyasidir.
Anlam farki olursa root canonical source esas alinmalidir.

## Localization Status

Bu mirror su an semantic parity ve validator coverage icin tutulur.
Dil kalitesi zamanla daha da iyilestirilebilir; canonical spec root dosyada korunur.
