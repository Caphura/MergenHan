...
- English repo koku canonical kaynaktir.
- `tr/` altindaki ayna ayni dosya yollarini, slug'lari ve kimlik zincirini koruyan Turkce localization mirror olarak tutulur.
...
- `scripts/` tek kopya olarak kalir ve locale-aware sekilde hem EN hem TR icerigi uzerinde calisir.
