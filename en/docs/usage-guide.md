...
- The repository root and canonical source remain Turkish.
- The English usage mirror lives under `en/README.md` and `en/docs/`.
- `scripts/` is locale-aware and supports both TR and EN catalog and validation flows.
